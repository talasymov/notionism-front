<template>
  <div class="container max-w-6xl mx-auto p-4 grid grid-cols-12">
    ...
    <div class="col-span-12 py-10">
      ...
      <p>
        Welcome to <a target="_blank" rel="noopener noreferrer" href="https://notionism.org">notionism.org</a>!
      </p>
      <p>
        These terms and conditions outline the rules and regulations for the use of Notionism's Website, located at <a
          target="_blank" rel="noopener noreferrer" href="https://notionism.org">https://notionism.org</a>.
      </p>
      <p>
        By accessing this website we assume you accept these terms and conditions. Do not continue to use <a
          target="_blank" rel="noopener noreferrer" href="https://notionism.org">notionism.org</a> if you do not agree to
      ...
      <p>
        We employ the use of cookies. By accessing <a target="_blank" rel="noopener noreferrer"
                                                      href="https://notionism.org">notionism.org</a>, you agreed to use
        cookies in agreement with the Notionism's Privacy Policy.
      </p>
      <p>
      ...
      <p>
        Unless otherwise stated, Notionism and/or its licensors own the intellectual property rights for all material on
        <a target="_blank" rel="noopener noreferrer" href="https://notionism.org">notionism.org</a>. All intellectual
        property rights are reserved. You may access this from <a target="_blank" rel="noopener noreferrer"
                                                                  href="https://notionism.org">notionism.org</a> for your
      ...
      <ul>
        <li>
          Republish material from <a target="_blank" rel="noopener noreferrer"
                                     href="https://notionism.org">notionism.org</a>
        </li>
        <li>
          Sell, rent or sub-license material from <a target="_blank" rel="noopener noreferrer"
                                                     href="https://notionism.org">notionism.org</a>
        </li>
        <li>
          Reproduce, duplicate or copy material from <a target="_blank" rel="noopener noreferrer"
                                                        href="https://notionism.org">notionism.org</a>
        </li>
        <li>
          Redistribute content from <a target="_blank" rel="noopener noreferrer" href="https://notionism.org">notionism.org</a>
        </li>
      </ul>
      <p>
      ...
      <p>
        ...
        areas of the website. Notionism does not filter, edit, publish or review Comments prior to their presence on the
        website. Comments do not reflect the views and opinions of Notionism,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and opinions. To the extent permitted by
        applicable laws, Notionism shall not be liable for the Comments or for any liability, damages or expenses caused
        and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.
      </p>
      <p>
        Notionism reserves the right to monitor all Comments and to remove any Comments which can be considered
      ...
      <p>
        You hereby grant Notionism a non-exclusive license to use, reproduce, edit and authorize others to use,
      ...
      <ul>
        ...
        <li>
          <a target="_blank" rel="noopener noreferrer" href="https://dot.com">dot.com</a> community sites;
        </li>
        <li>
      ...
      <p>
        ...
        Notionism; and (d) the link is in the context of general resource information.
      </p>
      <p>
      ...
      <p>
        ...
        you must inform us by sending an e-mail to Notionism. Please include your name, your organization name, contact
      ...
      <p>
        No use of Notionism's logo or other artwork will be allowed for linking absent a trademark license agreement.
      </p>
      <h3>
        iFrames
      </h3>
      ...
      <p>
        Please read <NuxtLink to="privacy-policy">Privacy Policy</NuxtLink>
      </p>
      <h3>
...
useHead({
    ...
    meta: [
        {name: 'description', content: 'These terms and conditions outline the rules and regulations for the use of Notionism\'s Website'}
    ],
    link: [
