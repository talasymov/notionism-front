        ...
        <div class="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
            ...
            <table class="w-full text-base text-left text-gray-500 mt-10">
                ...
                <tr v-for="kit in kits"
                    ...
                    <td class="py-4 px-6">
                        <NuxtLink :href="`/admin/kits/${kit.id}`">
                            {{ kit.title }}
                        </NuxtLink>
                    </td>
                    <td class="py-4 px-6">
...
const {data: {value: {kits: kits}}} = await useAsyncData('dashboard/kits', () => useBaseFetch('dashboard/kits'))

const create = async () => await useAsyncData('dashboard/kits/create', () => useBaseFetch('dashboard/kits', {
    method: 'POST'
})).then((resp) => router.push({'path': '/dashboard/kits/' + resp.data.value.kit.id}))
